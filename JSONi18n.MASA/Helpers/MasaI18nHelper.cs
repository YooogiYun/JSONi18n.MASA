...
namespace JSONi18n.MASA.Helpers;

public static class MasaI18nHelper
{
    public static IBlazorComponentBuilder AddI18nForMauiBlazor(this IBlazorComponentBuilder builder , string localesDirectory)
    {
        string supportedCulturesPath = Path.Combine(localesDirectory , "supportedCultures.json");
        ...
        {
            string culturePath = Path.Combine(localesDirectory , culture + ".json");
